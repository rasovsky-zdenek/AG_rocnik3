...
public class Vzor extends javax.swing.JFrame {
    ...
    public Vzor() {
        initComponents();
        //dopln hodnoty pro red, green, blue;
        //!!!!!!!DOPLN KOD!!!!!!!
    ...
    private void spinnerRedStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_spinnerRedStateChanged
       //vytvor metodu prevodNaInt(Jspinner spinner)
       //metoda prijme objekt spinneru a ziska z nej int, ktery vrati
       //pomoci metody prevodNaInt(Jspinner spinner) ziskejte hodnotu pro promennou red
    ...
    private void spinnerGreenStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_spinnerGreenStateChanged
       //pomoci metody prevodNaInt(Jspinner spinner) ziskejte hodnotu pro promennou green
    ...
    private void spinnerBlueStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_spinnerBlueStateChanged
      //pomoci metody prevodNaInt(Jspinner spinner) ziskejte hodnotu pro promennou blue
