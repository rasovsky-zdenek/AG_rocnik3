...
public class Vzor extends javax.swing.JFrame {
    ...
    public Vzor() {
        initComponents();
        //nastaveni r,g,b na 0 => cerna barva
        cisloBarvy = 0;
    ...
    private void initComponents() {
        ...
        fieldCisloBarvy = new javax.swing.JTextField();
        ...
        labelX.setText("Odstín šedé:");

        fieldCisloBarvy.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        fieldCisloBarvy.setText("0");
        fieldCisloBarvy.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        fieldCisloBarvy.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                fieldCisloBarvyKeyPressed(evt);
            }
        });
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(fieldCisloBarvy, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(labelX)
                            .addComponent(fieldCisloBarvy, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(45, 45, 45)
    ...
    private void tlacitkoPrekresliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tlacitkoPrekresliActionPerformed
        //ziskat novou hodnotu pro nastaveni r,g,b
        String t = fieldCisloBarvy.getText();
        //prevod textu na cislo
        cisloBarvy = Integer.parseInt(t);
        panelPlatno.repaint();
    }//GEN-LAST:event_tlacitkoPrekresliActionPerformed

    private void fieldCisloBarvyKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_fieldCisloBarvyKeyPressed
        if(KeyEvent.VK_ENTER == evt.getKeyCode()){
           System.out.println("Stisknut Enter");
           tlacitkoPrekresli.doClick();
        }
    }//GEN-LAST:event_fieldCisloBarvyKeyPressed
...
public void kresli(Graphics gr){
    System.out.println("Kreslím!");
     //graficky kontext (objekt zodpovedny za vykreslovani) Graphics2D (pretypovani)
      Graphics2D g = (Graphics2D)gr;
        ...
        //nastaveni barvy pro kresleni tvaru pomoci new Color(cisloBarvy,cisloBarvy,cisloBarvy)
        g.setColor(new Color(cisloBarvy,cisloBarvy,cisloBarvy));
        //vykresleni tvaru pomoci metod g.drawOval(hornilevyrohX,hornilevyrohY,delka,vyska)
    ...
    private javax.swing.JTextField fieldCisloBarvy;
